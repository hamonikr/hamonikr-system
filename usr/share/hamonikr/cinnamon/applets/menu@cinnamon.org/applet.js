    ...
    activate (event) {
        switch (this._action) {
            ...
            case "offload_launch":
                ...
                break;
            case "run_as_root":
                Util.spawnCommandLine("nohup /usr/local/bin/runasroot " + this._appButton.app.get_app_info().get_filename());
                break;			
            default:
...
class GenericApplicationButton extends SimpleMenuItem {
    ...
    populateMenu(menu) {
        ...
        if (appinfo.get_filename() != null) {
            ...
            menu.addMenuItem(menuItem);
	    //run as root
	    menuItem = new ApplicationContextMenuItem(this, _("Run as root"), "run_as_root", "system-run");
	    menu.addMenuItem(menuItem);
        }
